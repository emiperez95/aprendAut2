...
def __gainAndThreshold(varDict, examples, attribute):
  ...
  for threshold in possibleThresholds:
    ...
    HLess = (len(partitionLess)/len(examples))*__entropy(partitionLess, varDict["entropyFunc"])
    HEqualGreat = (len(partitionEqualGreat)/len(examples))*__entropy(partitionEqualGreat, varDict["entropyFunc"])
  ...
  cnt = varDict["counter"]
  cnt.oper(tm.time()-begin, len(possibleThresholds))
